...
const ticketMarketplaceRoutes = require('./routes/ticketMarketplaceRoutes');
const eventTodoRoutes = require('./routes/eventTodoRoutes');
...
app.use('/', ticketMarketplaceRoutes);
app.use('/', eventTodoRoutes);
