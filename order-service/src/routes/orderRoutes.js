...
router.post('/orders/user-payouts/onboarding-link', authorizeRoles(['USER']), orderController.createUserPayoutOnboardingLink);
router.get('/orders/user-payouts/onboarding-status', authorizeRoles(['USER']), orderController.getUserPayoutOnboardingStatus);
router.get('/orders/vendor-payouts/event/:eventId', authorizeRoles(['ADMIN', 'MANAGER']), orderController.listVendorPayoutsForEvent);
router.get('/orders/vendor-payouts/vendor/:vendorAuthId', authorizeRoles(['ADMIN', 'MANAGER', 'VENDOR']), orderController.listVendorPayoutsForVendor);
router.post('/orders/vendor-payouts/release', authorizeRoles(['ADMIN', 'MANAGER']), orderController.releaseVendorPayout);
router.post('/orders/user-payouts/release', authorizeRoles(['ADMIN', 'MANAGER']), orderController.releaseUserGeneratedRevenuePayout);
